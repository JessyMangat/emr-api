...
emrdb.updateCareProvider = (updatedCareProvider, id) => {
    ...
    return new Promise((resolve, reject) => {
        pool.query(sqlString, [
            updatedCareProvider.title,
            updatedCareProvider.first_name,
            updatedCareProvider.last_name,
            updatedCareProvider.date_of_birth,
            updatedCareProvider.gender,
            updatedCareProvider.street_number,
            updatedCareProvider.street_name,
            updatedCareProvider.state,
            updatedCareProvider.zip_code,
            updatedCareProvider.phone,
            updatedCareProvider.email,
            updatedCareProvider.school,
            id
        ], (err, results) => {
            if (err) {
                return reject(err);
